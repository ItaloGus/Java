 ...
 * @author Italo
 */
public class Tela_Administracao_Frente_Caixa extends javax.swing.JFrame {
    conexao con = new conexao();
    conexao con2 = new conexao();
    ArrayList produtosSelecionados = new ArrayList();
    ArrayList produtosId = new ArrayList();
    ArrayList produtosVendas = new ArrayList();
    Float valorTotal = 0.0f;
    /**
     * Creates new form Tela_Loja
     */ 
    public Tela_Administracao_Frente_Caixa() throws ParseException {
    ...
    Tela_Administracao_Selecao tela = null;
        try {
            ...
            Logger.getLogger(Tela_Administracao_Frente_Caixa.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        con2.executaSQL("select * from tbvenda");
        try{
            con2.rs.first();
            do{
                for(int i=0;i<produtosSelecionados.size();i++){
                    if((int)produtosId.get(i) == (int)con2.rs.getInt("id_produto")){
                        PreparedStatement pst = (PreparedStatement) con.conn.prepareStatement("update tbvenda set venda_produto = ? where id_produto = ?");
                        pst.setInt(1, (int) produtosVendas.get(i) + (int) con2.rs.getInt("venda_produto"));
                        pst.setInt(2, (int) produtosId.get(i));
                        pst.execute();
                }}}while (con2.rs.next());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao atualizar a tabela!\nErro:" + ex.getMessage(), "Error!", ERROR_MESSAGE);
        }
        JOptionPane.showConfirmDialog(null,"Deseja emitir nota fiscal?");
            // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Administracao_Frente_Caixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Tela_Administracao_Frente_Caixa().setVisible(true);
        ...
        try{
            ...
            do{ //Coloca os dados.
               if(jTextFieldIdProduto.getText().equals(Integer.toString(con.rs.getInt("cod_produto")))){
                    ...
                    produtosId.add((int)con.rs.getInt("cod_produto"));
                    produtosVendas.add((int) quantidade);
